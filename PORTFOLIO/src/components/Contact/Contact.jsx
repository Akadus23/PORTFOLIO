                    ...
                    <div class={`w-[100%] h-5/6 flex-row  bg-[#22007C]`}>
                        <div class="grid grid-cols-2 grid-rows-1 h-full">
                            <div class="flex flex-col justify-center justify-self-end items-start w-2/3" >
                                ...
                                <p class="text-slate-300" >I'm ready for new challenges, do you dare to meet them with me?</p>
                                <p class="text-slate-300" > Then leave me a message. ;)</p>
                                <div class="w-full flex flex-row items-center gap-2 text-slate-300 mt-4"><img class="w-8" src="/src/img/correo.png"></img> davilgo23@gmail.com </div>
                                <div class="w-full flex flex-row items-center gap-2 text-slate-300 mt-1"><img class="w-8" src="/src/img/marcador.png"></img> Bogotá, Colombia </div>
                                ...
                                <div class="bg-[#140152] w-2/3 h-2/3 rounded-lg border-[#450DFD] border-2 ">
                                    <form>
                                        ...
                                        <div class="flex flex-col m-4 gap-1">
                                            ...
                                            <textarea  class="rounded-md caret-[#ffb703] resize-none border-[#450DFD] border-2 bg-[#22007C] focus:border-[#ffb703] focus:outline-none pl-1 text-slate-300 text-sm" placeholder="Message" required name="message" id="message" rows="11"></textarea>
                                        </div>
                                        <button type="submit" class="border-[#450DFD] border-2 bg-[#ffb703] h-10 w-11/12 rounded-md text-[#22007C] text-xl mx-4">Send</button>
                                    </form>
                                </div>
